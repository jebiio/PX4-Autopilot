...
#ifndef KRISO_CKTOVCC_HPP
#define KRISO_CKTOVCC_HPP

#include <uORB/topics/kriso_cktovcc.h>

class MavlinkStreamKrisoCkToVcc : public MavlinkStream
{
public:
	static MavlinkStream *new_instance(Mavlink *mavlink) { return new MavlinkStreamKrisoCkToVcc(mavlink); }
...
private:
	explicit MavlinkStreamKrisoCkToVcc(Mavlink *mavlink) : MavlinkStream(mavlink) {}

	uORB::Subscription _home_sub{ORB_ID(kriso_cktovcc)};
