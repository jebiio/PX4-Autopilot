...
#ifndef KRISO_CATOVCC_HPP
#define KRISO_CATOVCC_HPP

#include <uORB/topics/kriso_catovcc.h>

class MavlinkStreamKrisoCaToVcc : public MavlinkStream
{
public:
	static MavlinkStream *new_instance(Mavlink *mavlink) { return new MavlinkStreamKrisoCaToVcc(mavlink); }

	static constexpr const char *get_name_static() { return "CATOVCC"; }
...
private:
	explicit MavlinkStreamKrisoCaToVcc(Mavlink *mavlink) : MavlinkStream(mavlink) {}
